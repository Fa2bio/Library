...
import com.github.fa2bio.domain.exception.IsbnMalFormedException;
...
public class IsbnService {
	...
	public VolumeInfo findBookByIsbn(String isbn) {
		...
		try {				
			...
			throw new IsbnMalFormedException("Wasn't possible generate URL.");
		} catch(IOException e) {
			throw new IsbnMalFormedException("Wasn't possible generate URL.");
		}
	}
	...
	private String validatingIsbn(String isbn) {
		...
		else throw new IsbnInvalidException("Isbn must be contains 10 or 13 digits");
